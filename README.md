...
2. In the root of your /config folder, create a file called climate.yaml
   ...
   - platform: gree
     ...
     anti_direct_blow: <OPTIONAL: input_boolean used to switch Anti Direct Blow feature on devices devices that have this functionality. Until next release, it should be set only when device   has this feature
