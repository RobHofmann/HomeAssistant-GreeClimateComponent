...
- To find a unit's own limit, send `["Pow"] * N` for growing N in one packet and watch for the first empty reply. `_pr-testing` style harnesses in the maintainers' setups do exactly that.
